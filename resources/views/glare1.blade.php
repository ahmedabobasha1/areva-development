...
@section('content')
  @php
    ...
    $isAr = $locale === 'ar';
    /** @var \App\Models\Glare1Landing $glare */
    $projectTypes = $glare->projectTypeOptions($locale);
    $heroTitle = nl2br(e($glare->localized('hero_title')));
  @endphp

  <section class="lp-hero" aria-label="{{ $isAr ? 'صفحة جليير 1' : 'GLARE1 landing' }}">
    ...
    <div class="lp-hero-top">
      <a href="{{ route('glare1', ['locale' => $locale]) }}" class="lp-logo" aria-label="GLARE1">
        <img
          src="{{ $glare->logoUrl() }}"
          alt="GLARE1 — The Power of Business"
          width="180"
          height="102"
          loading="eager"
        >
    ...
    <div class="lp-hero-grid">
      ...
      <div id="contact" class="lp-hero-form" aria-labelledby="lp-contact-heading">
        ...
        >
          @csrf
          <input type="hidden" name="source_page" value="glare1-landing">
