...
namespace App\Filament\Resources\Glare1Landings;

use App\Filament\Resources\Glare1Landings\Pages\ManageGlare1Landing;
...
class Glare1LandingResource extends Resource
{
    protected static ?string $model = Glare1Landing::class;
    ...
    protected static ?string $navigationLabel = 'GLARE1 Landing';

    protected static ?string $modelLabel = 'GLARE1 Landing';

    protected static ?string $pluralModelLabel = 'GLARE1 Landing';

    protected static ?string $slug = 'glare1-landing';
                                ...
                                Section::make('Hero content')
                                    ...
                                    ->schema([
                                        ...
                                        Toggle::make('is_published')
                                            ->label('Published')
                                            ->default(true)
                                            ->helperText('When off, the public /glare1 page returns 404.'),
    ...
    {
        return [
            'index' => ManageGlare1Landing::route('/'),
        ];
    }
