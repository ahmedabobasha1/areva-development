...
class Glare1Landing extends Model implements HasMedia
{
    use HasTranslations;
    ...
    public static function defaults(): array
    {
        return [
            ...
            'meta_title' => [
                'en' => 'GLARE1 — Designing Spaces. Creating Experiences.',
                'ar' => 'GLARE1 — نصمم المساحات ونصنع التجارب',
            ],
            'meta_description' => [
                'en' => 'Bespoke interior design solutions from GLARE1 where creativity, functionality, and refined details come together.',
                'ar' => 'حلول تصميم داخلي مخصصة من GLARE1 حيث تلتقي الإبداع والوظيفة والتفاصيل الراقية.',
            ],
            'project_types' => [
                [
